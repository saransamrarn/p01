...
<!-- custom -->
<tr class="swpm-admin-edit-coin">
    <th scope="row"><label for="coin"><?php echo SwpmUtils::_('Coin') ?> </label></th>
    <td><input class="regular-text" name="coin" type="text" id="coin" value="<?php echo esc_attr($coin); ?>" /></td>
</tr>
